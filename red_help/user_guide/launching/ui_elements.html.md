...
itself has to take [agent](red_agent.html) into execution as a listener.
...
[agent](red_agent.html) is taken into execution as a listener.
...
take a look at [Debugging Robot](debug.html) topic.
