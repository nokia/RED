...
[Remote configuration](launching/remote_launch.html) is rather simple: it
...
agent](launching/red_agent.html) attached.

[Local configuration](launching/local_launch.html) is a bit more complicated:
...
is executing script with [RED agent](launching/red_agent.html) or not).
