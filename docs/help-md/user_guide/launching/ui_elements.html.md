...
itself has to take [agent](red_agent.html.md) into execution as a listener.
...
[agent](red_agent.html.md) is taken into execution as a listener.
...
take a look at [Debugging Robot](debug.html.md) topic.
