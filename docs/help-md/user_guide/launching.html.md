...
[Remote configuration](launching/remote_launch.html.md) is rather simple: it
...
agent](launching/red_agent.html.md) attached.

[Local configuration](launching/local_launch.html.md) is a bit more complicated:
...
is executing script with [RED agent](launching/red_agent.html.md) or not).
