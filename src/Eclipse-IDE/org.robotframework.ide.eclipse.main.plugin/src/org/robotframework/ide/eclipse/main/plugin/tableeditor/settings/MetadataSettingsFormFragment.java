...
public class MetadataSettingsFormFragment implements ISectionFormFragment, ISettingsFormFragment {
    ...
    public void initialize(final Composite parent) {
        ...
        metadataSection.setBackground(parent.getBackground());
        ...
        final Composite panel = createPanel(metadataSection);
    ...
    private NewElementsCreator<RobotElement> newElementsCreator() {
        return new NewElementsCreator<RobotElement>() {
            ...
            public RobotElement createNew(final int addingTokenRowIndex) {
                ...
                commandsStack.execute(new CreateFreshSettingCommand(section, "Metadata", newArrayList("data")));
    ...
    private void whenUserRequestedFilteringEnabled(@UIEventTopic(RobotSuiteEditorEvents.SECTION_FILTERING_ENABLED_TOPIC
        ...
        if (matches.getCollectors().contains(this)) {
            ...
            dataProvider.setFilter(new MetadataMatchesFilter(matches));
            table.refresh();
        }
    }
