...
public enum SyntaxHighlightingCategory {
    ...
    KEYWORD_CALL_FROM_LIB("call_lib_kw", new ColoringPreference(new RGB(0, 128, 192), SWT.BOLD), new ColoringPreference(new RGB(148, 100, 1), SWT.BOLD), "Keyword from library calls"),
    ...
    KEYWORD_CALL_LIBRARY("library", new ColoringPreference(new RGB(0, 128, 192), SWT.BOLD), new ColoringPreference(new RGB(148, 100, 1), SWT.BOLD), "Keyword call full name prefix"),
