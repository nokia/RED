 ...
 *
 */
public class KeywordSearch extends TargetedSearch {

    public KeywordSearch(final SearchPattern searchPattern, final RobotModel model, final SearchResult result) {
