...
class OnSaveLibrariesAutodiscoveryTrigger2 implements IExecutionListener {

    private static final String SAVE_ALL_COMMAND_ID = "org.eclipse.ui.file.saveAll";

    private static OnSaveLibrariesAutodiscoveryTrigger2 globalBatchSaveResponsibleTrigger = null;
