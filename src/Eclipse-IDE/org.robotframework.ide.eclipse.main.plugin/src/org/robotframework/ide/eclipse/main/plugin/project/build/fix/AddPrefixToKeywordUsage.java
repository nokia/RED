...
public class AddPrefixToKeywordUsage extends RedSuiteMarkerResolution {
    ...
    public Optional<ICompletionProposal> asContentProposal(final IMarker marker, final IDocument document,
        ...
        final IRegion regionToChange = RobotProblem.getRegionOf(marker);

        return Optional.of(new CompletionProposal(toInsert, regionToChange.getOffset(), regionToChange.getLength(),
                toInsert.length(), ImagesManager.getImage(RedImages.getChangeImage()), getLabel(), null,
