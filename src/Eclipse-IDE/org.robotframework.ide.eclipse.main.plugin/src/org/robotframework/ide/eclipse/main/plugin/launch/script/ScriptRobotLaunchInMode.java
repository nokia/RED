...
public abstract class ScriptRobotLaunchInMode {
    ...
    public void launch(final ScriptRobotLaunchConfiguration robotConfig, final ILaunch launch,
    ...
    protected final RunCommandLine prepareCommandLine(final ScriptRobotLaunchConfiguration robotConfig, final int port)
