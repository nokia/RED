...
public class SuitePostconditionDeclarationExistanceValidator extends ADeprecatedSettingElement {

    private final RobotSettingsSection section;

    public SuitePostconditionDeclarationExistanceValidator(final IFile file, final ProblemsReportingStrategy reporter,
    ...
    public IProblemCause getProblemId() {
        return GeneralSettingsProblem.SUITE_POSTCONDITION_SYNONIM;
    }
