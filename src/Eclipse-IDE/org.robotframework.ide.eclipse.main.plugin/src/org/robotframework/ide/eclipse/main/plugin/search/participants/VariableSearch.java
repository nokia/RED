 ...
 *
 */
public class VariableSearch extends TargetedSearch {

    public VariableSearch(final SearchPattern searchPattern, final RobotModel model, final SearchResult result) {
