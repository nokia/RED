...
class RobotLaunchInRemoteDebugMode extends RobotLaunchInMode {
    ...
    protected Process launchAndAttachToProcess(final RobotLaunchConfiguration robotConfig, final ILaunch launch,
        ...
        // getRobotRuntimeEnvironment(robotProject);
        //
        ...
        // final String version = robotConfig.isUsingInterpreterFromProject() ?
        ...
        // "Debug server is listening on " + host + ":" + remoteDebugPort + ", you can run a remote
        // test");
        // } else {
        ...
        //
        // try {
        // final RobotDebugTarget target = new RobotDebugTarget(launch, eclipseProcess,
        // consoleFacade, true);
