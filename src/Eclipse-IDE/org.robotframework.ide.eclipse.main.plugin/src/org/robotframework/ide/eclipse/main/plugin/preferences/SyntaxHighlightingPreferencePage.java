...
public class SyntaxHighlightingPreferencePage extends RedPreferencePage {
    ...
    Stream<StyleRange> createStyleRanges() {
        return Stream.of(
                ...
                createStyleRanges(SyntaxHighlightingCategory.KEYWORD_CALL_LIBRARY,
                        SyntaxHighlightingPreferencePageSource.keywordCallLibraryStartIndexes,
                        SyntaxHighlightingPreferencePageSource.keywordCallLibraryRangeLengths),
