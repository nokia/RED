...
import org.robotframework.ide.eclipse.main.plugin.model.cmd.cases.MoveKeywordCallInCaseDownCommand;
    ...
    public static class E4MoveCaseDownHandler {
        ...
        public void moveCaseDown(@Named(Selections.SELECTION) final IStructuredSelection selection) {
            ...
            if (maybeKeywordCall.isPresent()) {
                commandsStack.execute(new MoveKeywordCallInCaseDownCommand(maybeKeywordCall.get()));
