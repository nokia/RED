...
import org.robotframework.ide.eclipse.main.plugin.tableeditor.code.handler.DeleteCellHandler.E4DeleteCellHandler;
    ...
    public static class E4DeleteCellHandler {
        ...
        public Object deleteCell(final RobotEditorCommandsStack commandsStack,
            ...
            final List<? extends EditorCommand> commands = new CodeAttributesCommandsProvider()
                    .provideRemoveAttributeCommand(element.get(), index);
