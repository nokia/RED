...
public class NewRobotTestCaseWizard extends BasicNewResourceWizard {
    ...
    public void addPages() {
        ...
        mainPage = new WizardNewFileCreationPage("New Robot Project", getSelection());
