...
public class KeywordSettingsRuleTest {

    private final KeywordSettingsRule testedRule = new KeywordSettingsRule(new Token("token"));
    ...
    private boolean isSettingDeclarationToken(final RobotToken token) {
        return token.getText().startsWith("[") && Character.isLowerCase(token.getText().charAt(1))
