...
public class CaseNameRuleTest {

    private final CaseNameRule testedRule = new CaseNameRule(new Token("token"));
    ...
    @Test
    public void testCaseNameIsRecognized() {
        ...
        for (final RobotToken token : TokensSource.createTokens()) {
            ...
            if (token.getText().equals("case 1") || token.getText().equals("case 2")) {
                thereWasName = true;
    ...
    @Test
    public void testCaseNameIsRecognized_evenWhenPositionIsInsideToken() {
        boolean thereWasName = false;
        for (final RobotToken token : TokensSource.createTokens()) {
