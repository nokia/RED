...
public class TestCaseSettingsCallRuleTest {

    private final TestCaseSettingsCallRule testedRule = new TestCaseSettingsCallRule(new Token("token"));
    ...
    public void testCaseSettingCallIsRecognized() {
        ...
        for (final RobotToken token : TokensSource.createTokens()) {
            ...
            if (token.getText().equals("tc_setting_call")) {
                thereWasName = true;
