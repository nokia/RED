...
public class BaseAssistProposalTest {

    @Test
    public void testProposalWithEmptyContentAndEmptyMatch() {
        final BaseAssistProposal proposal = createProposalUnderTest("", ProposalMatch.EMPTY);
    ...
    public void testProposalWithNonEmptyContentAndEmptyMatch() {
        final BaseAssistProposal proposal = createProposalUnderTest("content", ProposalMatch.EMPTY);
    ...
    public void testProposalWithNonEmptyContentAndNonEmptyMatch() {
        final BaseAssistProposal proposal = createProposalUnderTest("content",
    ...
    private BaseAssistProposal createProposalUnderTest(final String content, final ProposalMatch match) {
        return new BaseAssistProposal(content, match) {
        };
    }
