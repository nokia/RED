...
public class ConvertCallToSettingTest {
    ...
    @Test
    public void testCaseExecutableRowIsProperlyConvertedToSetting() {
        ...
        ContextInjector.prepareContext().inWhich(eventBroker)
                .isInjectedInto(new ConvertCallToSetting(eventBroker, keywordCall, "[Tags]")).execute();
        ...
        assertThat(result.getArguments()).containsExactly("1", "2");
    ...
    @Test
    public void keywordExecutableRowIsProperlyConvertedToSetting() {
        final RobotSuiteFile model = new RobotSuiteFileCreator()
                .appendLine("*** Keywords ***")
                .appendLine("kw")
                .appendLine("  call  1  2  #comment")
    ...
    @Test
    public void testCaseExecutableRowIsProperlyConvertedToSetting_whenThereAreMoreCalls() {
        final RobotSuiteFile model = new RobotSuiteFileCreator()
                .appendLine("*** Test Cases ***")
                .appendLine("case")
    ...
    @Test
    public void keywordExecutableRowIsProperlyConvertedToSetting_whenThereAreMoreCalls() {
        final RobotSuiteFile model = new RobotSuiteFileCreator()
                .appendLine("*** Keywords ***")
                .appendLine("kw")
                .appendLine("  Log nothing")
