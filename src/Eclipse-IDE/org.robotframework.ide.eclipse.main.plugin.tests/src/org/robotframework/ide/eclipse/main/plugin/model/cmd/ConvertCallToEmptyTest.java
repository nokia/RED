...
public class ConvertCallToEmptyTest {
    ...
    @Test
    public void testCaseExecutableRowIsProperlyChangedToEmpty() {
        ...
        ContextInjector.prepareContext().inWhich(eventBroker)
                .isInjectedInto(new ConvertCallToEmpty(eventBroker, keywordCall, "")).execute();
    ...
    @Test
    public void keywordExecutableRowIsProperlyChangedToEmpty() {
        final RobotSuiteFile model = new RobotSuiteFileCreator()
                .appendLine("*** Keywords ***")
                .appendLine("kw")
                .appendLine("  call  1  2  #comment")
    ...
    @Test
    public void testCaseExecutableRowIsProperlyChangedToEmpty_whenThereAreMoreCalls() {
        final RobotSuiteFile model = new RobotSuiteFileCreator()
                .appendLine("*** Test Cases ***")
                .appendLine("case")
    ...
    @Test
    public void keywordExecutableRowIsProperlyChangedToEmpty_whenThereAreMoreCalls() {
        final RobotSuiteFile model = new RobotSuiteFileCreator()
                .appendLine("*** Keywords ***")
                .appendLine("kw")
                .appendLine("  Log nothing")
