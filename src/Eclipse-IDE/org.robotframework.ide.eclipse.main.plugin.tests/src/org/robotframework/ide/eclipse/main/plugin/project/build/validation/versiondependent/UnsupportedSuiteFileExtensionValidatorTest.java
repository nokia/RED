...
public class UnsupportedSuiteFileExtensionValidatorTest {

    @Test
    public void validatorIsNotApplicableForVersion32andAbove() {
        final UnsupportedSuiteFileExtensionValidator validator = new UnsupportedSuiteFileExtensionValidator(null, null,
                null, null);
        ...
        assertThat(validator.isApplicableFor(RobotVersion.from("3.1"))).isFalse();
        assertThat(validator.isApplicableFor(RobotVersion.from("3.1.5"))).isFalse();
        assertThat(validator.isApplicableFor(RobotVersion.from("3.2"))).isTrue();
        assertThat(validator.isApplicableFor(RobotVersion.from("3.5"))).isTrue();
    }
    ...
    public void problemIsReportedInTestsSuiteUsingTsvExtension() {
        ...
        assertThat(problems).containsExactly(new Problem(SuiteFileProblem.REMOVED_SUITE_FILE_EXTENSION, 1, 0, 18));
    }
    ...
    public void problemIsReportedInTasksSuiteUsingTsvExtension() {
        ...
        assertThat(problems).containsExactly(new Problem(SuiteFileProblem.REMOVED_SUITE_FILE_EXTENSION, 1, 0, 13));
    }
    ...
    private static Collection<Problem> validate(final String extension, final RobotSuiteFile fileModel,
        ...
        new UnsupportedSuiteFileExtensionValidator(file, fileModel, suiteSectionClass, reporter).validate();
