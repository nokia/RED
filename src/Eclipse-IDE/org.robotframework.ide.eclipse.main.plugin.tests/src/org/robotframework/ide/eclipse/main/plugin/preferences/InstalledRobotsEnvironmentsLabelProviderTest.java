...
public class InstalledRobotsEnvironmentsLabelProviderTest {
    ...
    public void testGettingForeground_forInvalidPythonInstallation() throws Exception {
        ...
        final InstalledRobotsEnvironmentsLabelProvider labelProvider = createLabelProvider();
    ...
    public void testGettingFont_forSelectedPythonInstallation() throws Exception {
        final IRuntimeEnvironment environment = new InvalidPythonRuntimeEnvironment(null);
        final Predicate<Object> shouldBeBold = elem -> elem == environment;
        final InstalledRobotsEnvironmentsLabelProvider labelProvider = createLabelProvider(shouldBeBold);
    ...
    private InstalledRobotsEnvironmentsLabelProvider createLabelProvider() {
        return createLabelProvider(elem -> false);
    }

    private InstalledRobotsEnvironmentsLabelProvider createLabelProvider(final Predicate<Object> shouldBeBold) {
        return new InstalledRobotsEnvironmentsLabelProvider(shouldBeBold) {
