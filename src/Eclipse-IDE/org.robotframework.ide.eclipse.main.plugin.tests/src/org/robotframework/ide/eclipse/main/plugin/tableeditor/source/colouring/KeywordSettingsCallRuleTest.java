...
public class KeywordSettingsCallRuleTest {
    ...
    private final KeywordSettingsCallRule testedRule = new KeywordSettingsCallRule(new Token("token"));
    ...
    @Test
    public void keywordSettingCallIsRecognized() {
        ...
        for (final RobotToken token : TokensSource.createTokens()) {
            ...
            if (token.getText().equals("kw_setting_call")) {
                thereWasName = true;
    ...
    @Test
    public void keywordSettingCallIsRecognized_evenWhenPositionIsInsideToken() {
        boolean thereWasName = false;
        for (final RobotToken token : TokensSource.createTokens()) {
