...
public class SettingsCallRuleTest {

    private final SettingsCallRule testedRule = new SettingsCallRule(new Token("token"));
    ...
    public void generalSettingKeywordCallIsRecognized() {
        ...
        for (final RobotToken token : TokensSource.createTokens()) {
            ...
            if (token.getText().equals("general_setting_call")) {
                thereWasName = true;
