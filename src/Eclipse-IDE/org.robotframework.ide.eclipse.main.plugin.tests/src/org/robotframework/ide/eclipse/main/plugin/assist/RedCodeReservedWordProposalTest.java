...
public class RedCodeReservedWordProposalTest {
    ...
    public void testProposalWithEmptyContentAndEmptyMatch() {
        final BaseAssistProposal proposal = new RedCodeReservedWordProposal("", ProposalMatch.EMPTY);
    ...
    public void testProposalWithNonEmptyContentAndEmptyMatch() {
        final BaseAssistProposal proposal = new RedCodeReservedWordProposal("content", ProposalMatch.EMPTY);
    ...
    public void testProposalWithNonEmptyContentAndNonEmptyMatch() {
        final BaseAssistProposal proposal = new RedCodeReservedWordProposal("content",
