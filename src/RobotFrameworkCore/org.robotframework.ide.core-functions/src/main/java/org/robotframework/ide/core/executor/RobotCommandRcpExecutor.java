...
class RobotCommandRcpExecutor implements RobotCommandExecutor {
    ...
    private static class XmlRpcTypeFactoryWithNil extends TypeFactoryImpl {
        ...
        // Value null is not a part of xml-rpc specification, it is an extension, so apache library
        // handles it with namespace added (<ex:nil>); unfortunately many other libraries does not
        // handle <ex:nil>, but handles <nil> instead, which is not even a part of specification.
        // This is so common that it is de-facto standard. This class is responsible for handling
        // <nil> tags
