...
public class TestCaseTemplateKeywordTrashArgumentMapper implements IParsingMapper {
    ...
    public boolean checkIfCanBeMapped(final RobotFileOutput robotFileOutput, final RobotLine currentLine,
        ...
        return currentState == ParsingState.TEST_CASE_SETTING_TEST_TEMPLATE_KEYWORD
    ...
    public RobotToken map(final RobotLine currentLine, final Stack<ParsingState> processingState,
        ...
        types.add(0, RobotTokenType.TEST_CASE_SETTING_TEMPLATE_KEYWORD_UNWANTED_ARGUMENT);
        rt.setText(text);
        ...
        processingState.push(ParsingState.TEST_CASE_SETTING_TEST_TEMPLATE_KEYWORD_UNWANTED_ARGUMENTS);
        return rt;
    }
}
