...
public class VersionAvailabilityInfo {
    ...
    private final RobotVersion deprecatedFrom;

    private final RobotVersion removedFrom;

    private VersionAvailabilityInfo(final String representation, final RobotVersion availableFrom,
            final RobotVersion deprecatedFrom, final RobotVersion removedFrom) {
    ...
    public RobotVersion getDeprecatedFrom() {
    ...
    public static class VersionAvailabilityInfoBuilder {
        ...
        public VersionAvailabilityInfoBuilder addRepresentation(final String representation) {
            this.representation = representation;
            return this;
        }

        public VersionAvailabilityInfoBuilder availableFrom(final String availableFrom) {
            this.availableFrom = RobotVersion.from(availableFrom);
            return this;
        }

        public VersionAvailabilityInfoBuilder deprecatedFrom(final String deprecatedFrom) {
            this.deprecatedFrom = RobotVersion.from(deprecatedFrom);
            return this;
        }

        public VersionAvailabilityInfoBuilder removedFrom(final String removedFrom) {
        ...
        public VersionAvailabilityInfo build() {
            ...
            if (deprecated == null) {
                deprecated = new RobotVersion(Integer.MAX_VALUE, Integer.MAX_VALUE);
            }
            ...
            return new VersionAvailabilityInfo(representation, available, deprecated, removed);
        }
    }
}
