...
public class KeywordArgumentsValueMapper implements IParsingMapper {
    ...
    public RobotToken map(final RobotLine currentLine, final Stack<ParsingState> processingState,
        ...
        final LocalSetting<UserKeyword> keywordArgument = arguments.get(arguments.size() - 1);
        keywordArgument.addToken(rt);

        processingState.push(ParsingState.KEYWORD_SETTING_ARGUMENTS_ARGUMENT_VALUE);
        return rt;
    }
}
