 ...
 */
package org.rf.ide.core.testdata.model.table.setting.mapping.suite;
...
public class SuiteTeardownMapper implements IParsingMapper {
    ...
    public RobotToken map(final RobotLine currentLine,
        ...
        if (setting.getSuiteTeardowns().isEmpty()) {
            final SuiteTeardown teardown = new SuiteTeardown(rt);
    ...
    public boolean checkIfCanBeMapped(final RobotFileOutput robotFileOutput,
        ...
        if (types.size() == 1
                && types.get(0) == RobotTokenType.SETTING_SUITE_TEARDOWN_DECLARATION) {
