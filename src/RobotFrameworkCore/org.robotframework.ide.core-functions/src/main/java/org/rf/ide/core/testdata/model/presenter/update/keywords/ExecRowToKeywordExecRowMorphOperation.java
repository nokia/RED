...
public class ExecRowToKeywordExecRowMorphOperation extends ExecutablesStepsHolderMorphOperation<UserKeyword> {

    @Override
    public boolean isApplicable(final ModelType elementType) {
        return elementType == ModelType.TEST_CASE_EXECUTABLE_ROW || elementType == ModelType.TASK_EXECUTABLE_ROW;
    }
    ...
    public AModelElement<?> insert(final UserKeyword keyword, final int index, final AModelElement<?> modelElement) {
        ...
        keyword.addElement(index, executableRow);
