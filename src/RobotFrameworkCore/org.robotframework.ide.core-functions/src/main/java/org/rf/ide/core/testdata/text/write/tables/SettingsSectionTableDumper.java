...
import org.rf.ide.core.testdata.text.write.tables.settings.TaskSetupDumper;
import org.rf.ide.core.testdata.text.write.tables.settings.TaskTeardownDumper;
import org.rf.ide.core.testdata.text.write.tables.settings.TaskTemplateDumper;
import org.rf.ide.core.testdata.text.write.tables.settings.TaskTimeoutDumper;
...
import org.rf.ide.core.testdata.text.write.tables.settings.TestTemplateDumper;
import org.rf.ide.core.testdata.text.write.tables.settings.TestTimeoutDumper;
...
public class SettingsSectionTableDumper extends ANotExecutableTableDumper<SettingTable> {
    ...
    private static List<ISectionElementDumper<SettingTable>> getDumpers(final DumperHelper helper) {
        ...
        dumpers.add(new TestTemplateDumper(helper));
        dumpers.add(new TestTimeoutDumper(helper));
        dumpers.add(new TaskSetupDumper(helper));
        dumpers.add(new TaskTeardownDumper(helper));
        dumpers.add(new TaskTemplateDumper(helper));
        dumpers.add(new TaskTimeoutDumper(helper));
