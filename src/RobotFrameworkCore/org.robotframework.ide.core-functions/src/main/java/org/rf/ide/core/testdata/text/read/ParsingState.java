...
public enum ParsingState {
    ...
    SETTING_LIBRARY_IMPORT_ALIAS_VALUE(TableType.SETTINGS, SETTING_LIBRARY_IMPORT_ALIAS),
    ...
    SETTING_RESOURCE_UNWANTED_ARGUMENTS(TableType.SETTINGS, SETTING_RESOURCE_IMPORT_PATH),
    ...
    SETTING_SUITE_SETUP_KEYWORD_ARGUMENT(TableType.SETTINGS, SETTING_SUITE_SETUP_KEYWORD),
    ...
    SETTING_SUITE_TEARDOWN_KEYWORD_ARGUMENT(TableType.SETTINGS, SETTING_SUITE_TEARDOWN_KEYWORD),
    ...
    SETTING_TEST_SETUP_KEYWORD_ARGUMENT(TableType.SETTINGS, SETTING_TEST_SETUP_KEYWORD),
    SETTING_TASK_SETUP(TableType.SETTINGS, SETTING_TABLE_INSIDE),
    SETTING_TASK_SETUP_KEYWORD(TableType.SETTINGS, SETTING_TASK_SETUP),
    SETTING_TASK_SETUP_KEYWORD_ARGUMENT(TableType.SETTINGS, SETTING_TASK_SETUP_KEYWORD),
    ...
    SETTING_TEST_TEARDOWN_KEYWORD_ARGUMENT(TableType.SETTINGS, SETTING_TEST_TEARDOWN_KEYWORD),
    SETTING_TASK_TEARDOWN(TableType.SETTINGS, SETTING_TABLE_INSIDE),
    SETTING_TASK_TEARDOWN_KEYWORD(TableType.SETTINGS, SETTING_TASK_TEARDOWN),
    SETTING_TASK_TEARDOWN_KEYWORD_ARGUMENT(TableType.SETTINGS, SETTING_TASK_TEARDOWN_KEYWORD),
    ...
    SETTING_TEST_TEMPLATE_KEYWORD_UNWANTED_ARGUMENTS(TableType.SETTINGS, SETTING_TEST_TEMPLATE_KEYWORD),
    SETTING_TASK_TEMPLATE(TableType.SETTINGS, SETTING_TABLE_INSIDE),
    SETTING_TASK_TEMPLATE_KEYWORD(TableType.SETTINGS, SETTING_TASK_TEMPLATE),
    SETTING_TASK_TEMPLATE_KEYWORD_UNWANTED_ARGUMENTS(TableType.SETTINGS, SETTING_TASK_TEMPLATE_KEYWORD),
    ...
    SETTING_TEST_TIMEOUT_MESSAGE_ARGUMENTS(TableType.SETTINGS, SETTING_TEST_TIMEOUT_VALUE),
    SETTING_TASK_TIMEOUT(TableType.SETTINGS, SETTING_TABLE_INSIDE),
    SETTING_TASK_TIMEOUT_VALUE(TableType.SETTINGS, SETTING_TASK_TIMEOUT),
    SETTING_TASK_TIMEOUT_MESSAGE_ARGUMENTS(TableType.SETTINGS, SETTING_TASK_TIMEOUT_VALUE),
    ...
    DICTIONARY_VARIABLE_VALUE(TableType.VARIABLES, DICTIONARY_VARIABLE_DECLARATION),
    ...
    TEST_CASE_INSIDE_ACTION_ARGUMENT(TableType.TEST_CASE, TEST_CASE_INSIDE_ACTION),
    TEST_CASE_SETTING_DOCUMENTATION_DECLARATION(TableType.TEST_CASE, TEST_CASE_DECLARATION),
    TEST_CASE_SETTING_DOCUMENTATION_TEXT(TableType.TEST_CASE, TEST_CASE_SETTING_DOCUMENTATION_DECLARATION),
    TEST_CASE_SETTING_SETUP(TableType.TEST_CASE, TEST_CASE_DECLARATION),
    TEST_CASE_SETTING_SETUP_KEYWORD(TableType.TEST_CASE, TEST_CASE_SETTING_SETUP),
    TEST_CASE_SETTING_SETUP_KEYWORD_ARGUMENT(TableType.TEST_CASE, TEST_CASE_SETTING_SETUP_KEYWORD),
    ...
    TEST_CASE_SETTING_TEARDOWN_KEYWORD(TableType.TEST_CASE, TEST_CASE_SETTING_TEARDOWN),
    TEST_CASE_SETTING_TEARDOWN_KEYWORD_ARGUMENT(TableType.TEST_CASE, TEST_CASE_SETTING_SETUP_KEYWORD),
    TEST_CASE_SETTING_TEST_TEMPLATE(TableType.TEST_CASE, TEST_CASE_DECLARATION),
    TEST_CASE_SETTING_TEST_TEMPLATE_KEYWORD(TableType.TEST_CASE, TEST_CASE_SETTING_TEST_TEMPLATE),
    ...
    TEST_CASE_SETTING_TEST_TIMEOUT_VALUE(TableType.TEST_CASE, TEST_CASE_SETTING_TEST_TIMEOUT),
    TEST_CASE_SETTING_TEST_TIMEOUT_MESSAGE_ARGUMENTS(TableType.TEST_CASE, TEST_CASE_SETTING_TEST_TIMEOUT_VALUE),

    TASKS_TABLE_HEADER(TableType.TASKS, null),
    TASKS_TABLE_INSIDE(TableType.TASKS, TASKS_TABLE_HEADER),
    TASK_DECLARATION(TableType.TASKS, TASKS_TABLE_INSIDE),
    TASK_EMPTY_LINE(TableType.TASKS, TASK_DECLARATION),
    TASK_INSIDE_ACTION(TableType.TASKS, TASK_DECLARATION),
    TASK_INSIDE_ACTION_ARGUMENT(TableType.TASKS, TASK_INSIDE_ACTION),
    TASK_SETTING_DOCUMENTATION_DECLARATION(TableType.TASKS, TASK_DECLARATION),
    TASK_SETTING_DOCUMENTATION_TEXT(TableType.TASKS, TASK_SETTING_DOCUMENTATION_DECLARATION),
    TASK_SETTING_SETUP(TableType.TASKS, TASK_DECLARATION),
    TASK_SETTING_SETUP_KEYWORD(TableType.TASKS, TASK_SETTING_SETUP),
    TASK_SETTING_SETUP_KEYWORD_ARGUMENT(TableType.TASKS, TASK_SETTING_SETUP_KEYWORD),
    TASK_SETTING_TAGS(TableType.TASKS, TASK_DECLARATION),
    TASK_SETTING_TAGS_TAG_NAME(TableType.TASKS, TASK_SETTING_TAGS),
    TASK_SETTING_TEARDOWN(TableType.TASKS, TASK_DECLARATION),
    TASK_SETTING_TEARDOWN_KEYWORD(TableType.TASKS, TASK_SETTING_TEARDOWN),
    TASK_SETTING_TEARDOWN_KEYWORD_ARGUMENT(TableType.TASKS, TASK_SETTING_SETUP_KEYWORD),
    TASK_SETTING_TASK_TEMPLATE(TableType.TASKS, TASK_DECLARATION),
    TASK_SETTING_TASK_TEMPLATE_KEYWORD(TableType.TASKS, TASK_SETTING_TASK_TEMPLATE),
    TASK_SETTING_TASK_TEMPLATE_KEYWORD_UNWANTED_ARGUMENTS(TableType.TASKS, TASK_SETTING_TASK_TEMPLATE_KEYWORD),
    TASK_SETTING_TASK_TIMEOUT(TableType.TASKS, TASK_DECLARATION),
    TASK_SETTING_TASK_TIMEOUT_VALUE(TableType.TASKS, TASK_SETTING_TASK_TIMEOUT),
    TASK_SETTING_TASK_TIMEOUT_MESSAGE_ARGUMENTS(TableType.TASKS, TASK_SETTING_TASK_TIMEOUT_VALUE),
    ...
    KEYWORD_SETTING_DOCUMENTATION_DECLARATION(TableType.KEYWORD, KEYWORD_DECLARATION),
    KEYWORD_SETTING_DOCUMENTATION_TEXT(TableType.KEYWORD, KEYWORD_SETTING_DOCUMENTATION_DECLARATION),
    ...
    KEYWORD_SETTING_ARGUMENTS_ARGUMENT_VALUE(TableType.KEYWORD, KEYWORD_SETTING_ARGUMENTS),
    ...
    KEYWORD_SETTING_TEARDOWN_KEYWORD(TableType.KEYWORD, KEYWORD_SETTING_TEARDOWN),
    KEYWORD_SETTING_TEARDOWN_KEYWORD_ARGUMENT(TableType.KEYWORD, KEYWORD_SETTING_TEARDOWN_KEYWORD),
    ...
    KEYWORD_SETTING_TIMEOUT_MESSAGE_ARGUMENTS(TableType.KEYWORD, KEYWORD_SETTING_TIMEOUT_VALUE),

    COMMENT_TABLE_HEADER(TableType.COMMENTS, null),
    COMMENT_TABLE_INSIDE(TableType.COMMENTS, COMMENT_TABLE_HEADER);
    ...
    private static boolean isSettingTableInside(final ParsingState state) {
        return (state == ParsingState.SETTING_TABLE_INSIDE || state == ParsingState.KEYWORD_DECLARATION
                || state == ParsingState.VARIABLE_TABLE_INSIDE || state == ParsingState.TEST_CASE_DECLARATION
                || state == ParsingState.TASK_DECLARATION);
    }

    public enum TableType {
        SETTINGS, VARIABLES, KEYWORD, TEST_CASE, TASKS, COMMENTS;
    }
}
