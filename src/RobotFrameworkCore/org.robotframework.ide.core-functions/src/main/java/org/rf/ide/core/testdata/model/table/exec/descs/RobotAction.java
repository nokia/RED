...
public class RobotAction {
    ...
    public RobotAction(final RobotToken originalToken, final List<IElementDeclaration> elementsOfToken) {
    ...
    public boolean isPresent() {
        return originalToken != null && !originalToken.getFilePosition().isNotSet() && elementsOfToken != null
                && !elementsOfToken.isEmpty();
    }

    public RobotToken getToken() {
        return originalToken == null ? new RobotToken() : originalToken;
    }
}
