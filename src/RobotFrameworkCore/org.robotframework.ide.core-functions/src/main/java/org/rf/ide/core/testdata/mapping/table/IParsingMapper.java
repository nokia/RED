...
public interface IParsingMapper {
    ...
    default boolean isApplicableFor(@SuppressWarnings("unused") final RobotVersion robotVersion) {
        return true;
    }
    ...
    RobotToken map(final RobotLine currentLine, final Stack<ParsingState> processingState,
