...
import org.rf.ide.core.testdata.text.read.postfixes.EndTerminatedForLoopsFixer;
...
public class PostProcessingFixActions {
    ...
    public PostProcessingFixActions() {
        this.fixers.addAll(Arrays.asList(new UnknownSettingsInExecutableTablesFixer(), new EndTerminatedForLoopsFixer(),
