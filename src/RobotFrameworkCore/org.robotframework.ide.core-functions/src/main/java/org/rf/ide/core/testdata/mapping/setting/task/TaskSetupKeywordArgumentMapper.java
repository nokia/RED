...
public class TaskSetupKeywordArgumentMapper implements IParsingMapper {
    ...
    public boolean checkIfCanBeMapped(final RobotFileOutput robotFileOutput, final RobotLine currentLine,
        ...
        if (state == ParsingState.SETTING_TASK_SETUP) {
        ...
        return state == ParsingState.SETTING_TASK_SETUP_KEYWORD
                || state == ParsingState.SETTING_TASK_SETUP_KEYWORD_ARGUMENT;
    }
    ...
    public RobotToken map(final RobotLine currentLine, final Stack<ParsingState> processingState,
        ...
        rt.getTypes().add(0, RobotTokenType.SETTING_TASK_SETUP_KEYWORD_ARGUMENT);
        rt.setText(text);
