...
public class TaskTemplateKeywordTrashArgumentMapper implements IParsingMapper {
    ...
    public boolean checkIfCanBeMapped(final RobotFileOutput robotFileOutput, final RobotLine currentLine,
        ...
        return currentState == ParsingState.TASK_SETTING_TASK_TEMPLATE_KEYWORD
                || currentState == ParsingState.TASK_SETTING_TASK_TEMPLATE_KEYWORD_UNWANTED_ARGUMENTS;
    }
    ...
    public RobotToken map(final RobotLine currentLine, final Stack<ParsingState> processingState,
        ...
        processingState.push(ParsingState.TASK_SETTING_TASK_TEMPLATE_KEYWORD_UNWANTED_ARGUMENTS);
        return rt;
    }
}
