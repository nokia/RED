...
public class TestCaseNotChangedDumperTest extends RobotFormatParameterizedTest {

    public TestCaseNotChangedDumperTest(final String extension, final FileFormat format) {
