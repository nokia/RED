...
public class SettingTableModelCreateTest {
    ...
    @Test
    public void testCreateSuiteSetup() {
    ...
    @Test
    public void testCreateSuiteTeardown() {
    ...
    @Test
    public void testCreateTestSetup() {
        final String keywordName = "setup";
        final List<String> settingArgs = newArrayList("arg1", "arg2");
        final String comment = "comment";
        final List<String> args = newArrayList(keywordName);
    ...
    @Test
    public void testCreateTestTeardown() {
        final String keywordName = "teardown";
        final List<String> settingArgs = newArrayList("arg1", "arg2");
        final String comment = "comment";
        final List<String> args = newArrayList(keywordName);
    ...
    @Test
    public void testCreateTestTimeout() {
    ...
    @Test
    public void testCreateForceTags() {
    ...
    @Test
    public void testCreateDefaultTags() {
        final List<String> tags = newArrayList("tag1", "tag2");
        final String comment = "comment";
    ...
    @Test
    public void testCreateLibraryImport() {
    ...
    @Test
    public void testCreateResourceImport() {
    ...
    @Test
    public void testCreateVariablesImport() {
    ...
    private void checkSettingArguments(final List<RobotToken> actualArguments, final List<String> expectedArguments) {
        assertEquals(actualArguments.size(), expectedArguments.size());
