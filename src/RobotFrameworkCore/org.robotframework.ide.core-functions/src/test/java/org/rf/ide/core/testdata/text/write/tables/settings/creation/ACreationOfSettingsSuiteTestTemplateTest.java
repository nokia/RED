...
public abstract class ACreationOfSettingsSuiteTestTemplateTest {

    public static final String PRETTY_NEW_DIR_LOCATION = "settings//testTemplate//new//";

    private final String extension;

    public ACreationOfSettingsSuiteTestTemplateTest(final String extension) {
    ...
    public void test_emptyFile_and_thanCreateTestTemplate() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "EmptyTestTemplateDeclarationOnly." + getExtension();
    ...
    public void test_emptyFile_createTestTemplate_andAddComments() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "TestTemplateDeclarationWithCommentsOnly." + getExtension();
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createTestTemplate_withKeywordName() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "TestTemplateDeclarationWithKeywordOnly." + getExtension();
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createTestTemplate_withKeywordName_andComment() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "TestTemplateDeclarationWithKeywordCommentOnly."
                + getExtension();
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createTestTemplate_withKeywordName_andThreeUnwanted() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "TestTemplateDeclarationWithKeyword3UnwantedArgsOnly."
                + getExtension();
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createTestTemplate_withKeywordName_andThreeUnwanted_andComment() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "TestTemplateDeclarationWithKeyword3UnwantedArgsCommentOnly."
                + getExtension();
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
