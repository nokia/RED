...
public class RobotDebugExecutionContextTest {
    ...
    private int[] test1_lines = new int[] { 7, 8, 10, 11, 28, 29, 30, 32, 33,
            3, 4, 5, 8, 9, 12, 35, 36, 39, 40, 37, 13, 14, 6, 7, 8, 3, 4, 5, 8,
            9, 9, 12, 13, 14, 3, 4, 5, 8, 9, 15, 18, 19, 15, 12, 13, 14, 3, 4,
            5, 8, 9, 15, 18, 19, 16, 19, 20, 42, 28, 29, 30, 32, 33, 3, 4, 5,
            8, 9, 43, 35, 36, 39, 40, 37, 21 };

    private int[] test2_lines = new int[] { 6, 16, 9, 18, 22, 12, 12, 13, 14,
            17, 13, 23, 19 };

    private int[] test3_lines = new int[] { 6, 6, 7, 8, 6, 7, 8, 6, 7, 8, 9,
            10, 17, 18, 18, 20, 18, 20, 18, 20, 21, 11, 12, 20, 20, 21, 22, 23,
            20, 21, 22, 23, 13 };

    private int[] test4_lines = new int[] { 4, 21, 23, 26, 28, 7, 12, 26, 28 };

    private int[] test5_lines = new int[] { 3, 20, 21, 26, 27, 8, 9, 10, 4, 23,
            24, 13, 27, 15, 16, 14, 29 };
    ...
    private int[] test9_lines = new int[] { 6, 6, 7, 8, -1, -1, -1, -1, -1, 9,
            11 };
    ...
    public void test_MultipleUserKeywordsAndResources()
        ...
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_1.robot");
        ...
        debugExecutionContext
                .startKeyword("key5", "Keyword", Arrays.asList(""));
        checkKeywordLine1();
        startKey1Keyword();
        startKey3Keyword();
        debugExecutionContext.endKeyword();
    ...
    public void test_MultipleResources() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_2.robot");
        ...
        debugExecutionContext.startTest("test a");
        debugExecutionContext
                .startKeyword("key1", "Keyword", Arrays.asList(""));
        checkKeywordLine2();
        ...
        debugExecutionContext
                .startKeyword("key2", "Keyword", Arrays.asList(""));
        checkKeywordLine2();
    ...
    public void test_ForLoop() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_3.robot");
    ...
    public void test_Comments() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_4.robot");
    ...
    public void test_SetupAndTeardownKeywords() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_5.robot");
        ...
        checkKeywordLine5();
        debugExecutionContext.endKeyword();
        debugExecutionContext.startKeyword("resource1.SetupKeyword",
                "Test Setup", Arrays.asList(""));
        checkKeywordLine5();
        debugExecutionContext.startKeyword("BuiltIn.Log", "Test Setup",
                Arrays.asList("12345"));
        checkKeywordLine5();
    ...
    public void test_SuiteSetupAndTeardownKeywords() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_6.robot");
    ...
    public void test_VariableDeclarationAsKeyword() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_7.robot");

        debugExecutionContext = new RobotDebugExecutionContext();
        debugExecutionContext.startSuite(modelFile.getParent());

        debugExecutionContext.startTest("test7");
        debugExecutionContext.startKeyword(
                "${var} = resource1.KeywordReturnValue", "Keyword",
                Arrays.asList(""));
        checkKeywordLine7();
        debugExecutionContext.startKeyword("BuiltIn.Log", "Keyword",
                Arrays.asList("Return value"));
        checkKeywordLine7();
        debugExecutionContext.endKeyword();
        debugExecutionContext.endKeyword();
        debugExecutionContext.startKeyword("BuiltIn.Log", "Keyword",
        ...
        debugExecutionContext.startKeyword(
                "${var2} = SecondKeywordReturnValue", "Keyword",
                Arrays.asList(""));
        checkKeywordLine7();
        debugExecutionContext.startKeyword("BuiltIn.Log", "Keyword",
                Arrays.asList("Return value"));
    ...
    public void test_ResourcesWithTheSameNames() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_8.robot");
    ...
    public void test_ForLoopWithUserKeyword() throws URISyntaxException {
        linesCounter = 0;
        RobotFile modelFile = RobotModelTestProvider
                .getModelFile("test_ExeContext_9.robot");
    ...
    private void startKey3Keyword() {
        debugExecutionContext
                .startKeyword("key3", "Keyword", Arrays.asList(""));
        checkKeywordLine1();
        startBuiltInLogKeyword1();
        debugExecutionContext
                .startKeyword("key4", "Keyword", Arrays.asList(""));
        checkKeywordLine1();
        startBuiltInLogKeyword1();
        startBuiltInLogKeyword1();
        debugExecutionContext.endKeyword();
    ...
    private void checkKeywordLine1() {
        Assert.assertEquals(test1_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }


    private void checkKeywordLine2() {
        Assert.assertEquals(test2_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine3() {
        Assert.assertEquals(test3_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine4() {
        Assert.assertEquals(test4_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine5() {
        Assert.assertEquals(test5_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine6() {
        Assert.assertEquals(test6_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine7() {
        Assert.assertEquals(test7_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine8() {
        Assert.assertEquals(test8_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
    ...
    private void checkKeywordLine9() {
        Assert.assertEquals(test9_lines[linesCounter], debugExecutionContext
                .findKeywordPosition().getLineNumber());
        linesCounter++;
    }
}
