...
public class SuiteTeardownRecognizerTest {
    ...
    private final SuiteTeardownRecognizer rec = new SuiteTeardownRecognizer();

    @Test
    public void test_suiteSetupColonWord_allCombinations() {
        final List<String> combinations = new CombinationGenerator().combinations("Suite Teardown:");
    ...
    public void test_getPattern() {
        assertThat(rec.getPattern().pattern()).isEqualTo("[ ]?"
                ...
                + ATokenRecognizer.createUpperLowerCaseWord("Teardown") + "([\\s]*:)?");
