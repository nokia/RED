...
public class CreationOfSettingsSuiteTeardownTest {
    ...
    private static final String PRETTY_NEW_DIR_LOCATION = "settings//suiteTeardown//new//";

    @Test
    public void test_emptyFile_and_thanCreateSuiteTeardown() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "EmptySuiteTeardownDeclarationOnly.txt";
    ...
    public void test_emptyFile_createSuiteTeardown_andAddComments() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "SuiteTeardownDeclarationWithCommentsOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createSuiteTeardown_andKeywordOnly() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "SuiteTeardownDeclarationWithKeywordOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createSuiteTeardown_andKeyword_andComments() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "SuiteTeardownDeclarationWithKeywordCommentsOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createSuiteTeardown_andKeyword_andThreeArgs() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "SuiteTeardownDeclarationWithKeyword3ArgsOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_createSuiteTeardown_andKeyword_andThreeArgs_andComment() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "SuiteTeardownDeclarationWithKeyword3ArgsAndCommentOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
