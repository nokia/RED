...
public class CreationOfSettingsVariablesImportTest {
    ...
    private static final String PRETTY_NEW_DIR_LOCATION = "settings//variablesImport//new//";

    @Test
    public void test_emptyFile_and_thanCreateVariablesImport() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "EmptyVariableDeclarationOnly.txt";
    ...
    public void test_emptyFile_and_thanCreateVariablesImport_withName() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "VariableDeclarationWithVariableNameOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_and_thanCreateVariablesImport_withNameAnd_ThreeCommentTokens() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "VariableDeclarationWithPathNameAndThreeCommentOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_and_thanCreateVariablesImport_with_ThreeCommentTokens() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "VariableDeclarationWithThreeCommentOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_and_thanCreateVariablesImport_withNameAnd_ThreeArguments() throws Exception {
        // prepare
        final String fileName = PRETTY_NEW_DIR_LOCATION + "VariableDeclarationWithPathNameAndThreeArgsOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
    ...
    public void test_emptyFile_and_thanCreateVariablesImport_withNameAnd_ThreeArgumentsAnd_ThreeComments()
        ...
        final String fileName = PRETTY_NEW_DIR_LOCATION
                + "VariableDeclarationWithPathNameAndThreeArgsThreeCommentsOnly.txt";
        final RobotFile modelFile = NewRobotFileTestHelper.getModelFileToModify("2.9");
