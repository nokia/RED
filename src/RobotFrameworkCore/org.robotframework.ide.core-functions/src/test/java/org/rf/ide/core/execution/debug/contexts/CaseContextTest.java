...
public class CaseContextTest {
    ...
    public void testCaseContextHasNoSourceAssociatedIfNotProvided() {
        ...
        final CaseContext context1 = new CaseContext("error");
        final CaseContext context2 = new CaseContext(newArrayList(), null, -1, "error");
        final CaseContext context3 = new CaseContext(test, null, newArrayList(), "template");
        final CaseContext context4 = new CaseContext(test, null, newArrayList(), "template", "error");
    ...
    public void testCaseContextHasSourceAssociatedWhenProvided() {
        ...
        final CaseContext context1 = new CaseContext(newArrayList(), URI.create("file:///file1.robot"), 42,
                "error");
        final CaseContext context2 = new CaseContext(test, URI.create("file:///file2.robot"), newArrayList(),
                "template");
        final CaseContext context3 = new CaseContext(test, URI.create("file:///file3.robot"), newArrayList(),
                "template", "error");
    ...
    public void testCaseContextIsNotErroneousWhenNoErrorMessageIsProvided() {
        ...
        final CaseContext context1 = new CaseContext(null);
        final CaseContext context2 = new CaseContext(newArrayList(), null, -1, null);
        final CaseContext context3 = new CaseContext(test, null, newArrayList(), "template");
        final CaseContext context4 = new CaseContext(test, null, newArrayList(), "template", null);
    ...
    public void testCaseContextIsErroneousWhenErrorMessageIsProvided() {
        ...
        final CaseContext context1 = new CaseContext("error1");
        final CaseContext context2 = new CaseContext(newArrayList(), null, -1, "error2");
        final CaseContext context3 = new CaseContext(test, null, newArrayList(), "template", "error3");
    ...
    public void erroneousExecutableContextIsReturned_whenMovingToNormalKeywordButThereIsNoTestCaseInContext() {
        ...
        final CaseContext context = new CaseContext(newArrayList(model), URI.create("file:///file.robot"), 42,
                null);
    ...
    public void erroneousExecutableContextIsReturned_whenMovingToNormalKeywordButThereAreNoExecutablesInside() {
        ...
        final CaseContext context = new CaseContext(test, modelUri, newArrayList(model), null);
        final StackFrameContext newContext = context.moveTo(
                new RunningKeyword("lib", "kw", KeywordCallType.NORMAL_CALL), mock(RobotBreakpointSupplier.class));
    ...
    public void erroneousSetupContextIsReturned_whenMovingToSetupButThereIsNoTestAndNoModelsToLook() {
        final CaseContext context = new CaseContext("error");
    ...
    public void erroneousSetupContextIsReturned_whenThereIsNoTestSetupAnywhere() {
        ...
        final CaseContext context = new CaseContext(newArrayList(model), modelUri, 42, null);
        final StackFrameContext newContext = context.moveTo(new RunningKeyword("lib", "kw", KeywordCallType.SETUP),
                mock(RobotBreakpointSupplier.class));
    ...
    public void validSetupContextIsReturned_whenMovingToTestSetupAndMatchingCallIsFound_withMultipleParents() {
        ...
        final CaseContext context = new CaseContext(newArrayList(model1, model2, model3), modelUri, 42, null);
        final StackFrameContext newContext = context.moveTo(new RunningKeyword("lib", "kw", KeywordCallType.SETUP),
                mock(RobotBreakpointSupplier.class));
    ...
    @Test
    public void erroneousSetupContextIsReturned_whenMovingToTestSetupAndMatchingCallIsOverriddenWithNonMatchingInFileUnder() {
        ...
        final CaseContext context = new CaseContext(newArrayList(model1, model2), modelUri, 42, null);
        final StackFrameContext newContext = context.moveTo(new RunningKeyword("lib", "kw", KeywordCallType.SETUP),
                mock(RobotBreakpointSupplier.class));
