...
import org.rf.ide.core.testdata.model.table.variables.descs.impl.old.IElementDeclaration;
import org.rf.ide.core.testdata.model.table.variables.descs.impl.old.IndexDeclaration;
import org.rf.ide.core.testdata.model.table.variables.descs.impl.old.JoinedTextDeclarations;
...
public class VariableExtractorTest {
    ...
    public void test_extractionOf_EnvironmentVariable_ONLY() {
        ...
        assertThat(variableDeclaration.getType()).isEqualTo(VariableType.ENVIRONMENT);
    ...
    public void test_extractionOf_ScalarVariable_ONLY_withoutPositionSet() {
        ...
        assertThat(mapResult.getCorrectVariables()).hasSize(1);
        final VariableDeclaration variableDeclaration = mapResult.getCorrectVariables().get(0);
        assertThat(variableDeclaration.getType()).isEqualTo(VariableType.SCALAR);
    ...
    public void test_extractionOf_ScalarVariable_withException() {
        ...
        when(mapper.map(any(FilePosition.class), any(Container.class))).thenThrow(cause);
        ...
        assertThatExceptionOfType(VariableExtractor.VariableExtractionException.class)
                .isThrownBy(() -> extractor.extract(varToken))
                .withMessage("An exception occurs during variable extraction at position "
