 ...
 */
public class SuitePreconditionDeclarationTest extends
        ARecognizerSequenceWithOptionalLastColonTest {

    public SuitePreconditionDeclarationTest() {
        super(SuitePreconditionDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_withOptionalColon_shouldReturnOneContext()
        ...
        // prepare
        String text = "Suite Precondition:";
        ...
        assertThat(comment.getType()).isEqualTo(
                SettingTableRobotContextType.TABLE_SETTINGS_SUITE_PRECONDITION);
