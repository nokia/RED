 ...
 */
public class ImportVariablesDeclarationTest extends
        ARecognizerSequenceWithOptionalLastColonTest {

    public ImportVariablesDeclarationTest() {
        super(ImportVariablesDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_witOptionalColon_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                SettingTableRobotContextType.TABLE_SETTINGS_VARIABLES);

        assertTokensForUnknownWords(comment.getContextTokens(),
                new IRobotTokenType[] { RobotWordType.VARIABLES_WORD,
    ...
    public void test_recognize_word_is_correct_optionalColonIsNotPresent_shouldReturnOneContext()
        ...
        assertTokensForUnknownWords(comment.getContextTokens(),
                new IRobotTokenType[] { RobotWordType.VARIABLES_WORD }, 0,
                new FilePosition(1, 1), new String[] {});
    }
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.VARIABLES_WORD);
    }
