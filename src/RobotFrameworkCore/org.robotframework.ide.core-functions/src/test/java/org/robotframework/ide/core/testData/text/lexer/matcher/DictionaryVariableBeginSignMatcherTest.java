 ...
 */
public class DictionaryVariableBeginSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoAmpersandSignsInTempBuffer_shouldReturn_two_SINGLE_DICTIONARY_BEGIN_AMPERSAND_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleAmpersandSignInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("&");
    ...
    @Before
    public void setUp() {
        matcher = new DictionaryVariableBeginSignMatcher();
    }
