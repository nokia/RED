 ...
 */
public class IndexEndSquareSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoSquareBracketCloseInTempBuffer_shouldReturn_two_SINGLE_POSSITION_INDEX_END_SQUARE_BRACKET_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleSquareBracketCloseInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("]");
        ...
        assertTokens(
                output,
                new RobotTokenType[] { RobotTokenType.SINGLE_POSSITION_INDEX_END_SQUARE_BRACKET },
                0, 1);
    }
    ...
    @Before
    public void setUp() {
        matcher = new IndexEndSquareSignMatcher();
    }
