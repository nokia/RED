 ...
 */
public class KeywordArgumentsDeclarationTest extends
        ARecognizerSequenceInBracketsTest {

    public KeywordArgumentsDeclarationTest() {
        super(KeywordArgumentsDeclaration.class);
    }
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.ARGUMENTS_WORD);
    }
