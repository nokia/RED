 ...
 */
public class TestTagsDeclarationTest extends ARecognizerSequenceInBracketsTest {

    public TestTagsDeclarationTest() {
        super(TestTagsDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                TestCaseTableRobotContextType.TABLE_TEST_CASE_SETTINGS_TAGS);
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.TAGS_WORD);
    }
