 ...
 */
public class ImportLibraryAliasDeclarationTest extends ARecognizerTest {

    public ImportLibraryAliasDeclarationTest() {
        super(ImportLibraryAliasDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                SettingTableRobotContextType.TABLE_SETTINGS_LIBRARY_ALIASES);

        assertTokensForUnknownWords(comment.getContextTokens(),
                new IRobotTokenType[] { RobotWordType.WITH_WORD,
                        RobotSingleCharTokenType.SINGLE_SPACE,
                        RobotWordType.NAME_WORD }, 0, new FilePosition(1, 1),
                new String[] {});
    }
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.WITH_WORD,
