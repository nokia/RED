 ...
 */
public class QuoteMarkSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoQuoteMarksInTempBuffer_shouldReturn_two_SINGLE_QUOTE_MARK_tokens() {
        // prepare
        ...
        for (int charIndex = 0; charIndex < tempBuffer.length(); charIndex++) {
            ...
            if ((charIndex + 1) % 2 == 0) {
                expectedSequenceOfTypes = new RobotType[] {
                        ...
                        RobotTokenType.SINGLE_ASTERISK,
                        RobotTokenType.SINGLE_QUOTE_MARK,
                        RobotTokenType.SINGLE_QUOTE_MARK };
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleQuoteMarkInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("\"");
        ...
        assertTokens(output,
                new RobotTokenType[] { RobotTokenType.SINGLE_QUOTE_MARK }, 0, 1);
    }
    ...
    @Before
    public void setUp() {
        matcher = new QuoteMarkSignMatcher();
    }
