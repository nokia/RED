 ...
 */
public class KeywordTimeoutDeclarationTest extends
        ARecognizerSequenceInBracketsTest {

    public KeywordTimeoutDeclarationTest() {
        super(KeywordTimeoutDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                KeywordTableRobotContextType.TABLE_KEYWORD_SETTINGS_TIMEOUT);
