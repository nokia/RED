 ...
 * 
 * @see EscapedEqualsSign
 */
public class EscapedEqualsSignTest extends ARecognizerTest {

    public EscapedEqualsSignTest() {
        super(EscapedEqualsSign.class);
    }
    ...
    public void test_backslashFollowing_sign_shouldReturn_oneElement()
        ...
        assertForSingleTextWithEquals_atTheBeginning(additionalTextStartsWithSign);
    }


    private void assertForSingleTextWithEquals_atTheBeginning(String textInput)
            throws FileNotFoundException, IOException {
        // prepare
        ...
        assertTokensForUnknownWords(
                ...
                new IRobotTokenType[] {
                        ...
                        RobotSingleCharTokenType.SINGLE_EQUAL }, 0,
                new FilePosition(1, 1), new String[] {});
    }


    @Test
    public void test_escapedBackslashAndThen_atEquals_shouldReturn_anEmptyList()
            throws FileNotFoundException, IOException {
        String text = "\\\\=";
    ...
    @Test
    public void test_noDollarEqualsFollowingBackslashCharacter_shouldReturn_anEmptyList()
            throws FileNotFoundException, IOException {
    ...
    public void test_getContextType() {
        assertThat(context.getContextType()).isEqualTo(
                SimpleRobotContextType.ESCAPED_EQUALS_SIGN);
    }
}
