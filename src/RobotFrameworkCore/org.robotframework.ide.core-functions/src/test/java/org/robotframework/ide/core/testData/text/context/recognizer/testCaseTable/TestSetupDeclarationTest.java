 ...
 */
public class TestSetupDeclarationTest extends ARecognizerSequenceInBracketsTest {

    public TestSetupDeclarationTest() {
        super(TestSetupDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                TestCaseTableRobotContextType.TABLE_TEST_CASE_SETTINGS_SETUP);
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.SETUP_WORD);
    }
