 ...
 */
public class EnvironmentVariableBeginSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoProcentSignsInTempBuffer_shouldReturn_two_SINGLE_ENVIRONMENT_BEGIN_PROCENT_tokens() {
        // prepare
        ...
        for (int charIndex = 0; charIndex < tempBuffer.length(); charIndex++) {
            ...
            if ((charIndex + 1) % 2 == 0) {
                expectedSequenceOfTypes = new RobotType[] {
                        ...
                        RobotTokenType.SINGLE_ASTERISK,
                        RobotTokenType.SINGLE_ENVIRONMENT_BEGIN_PROCENT,
                        RobotTokenType.SINGLE_ENVIRONMENT_BEGIN_PROCENT };
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleProcentSignInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("%");
        ...
        assertTokens(
                output,
                new RobotTokenType[] { RobotTokenType.SINGLE_ENVIRONMENT_BEGIN_PROCENT },
                0, 1);
    }
    ...
    @Before
    public void setUp() {
        matcher = new EnvironmentVariableBeginSignMatcher();
    }
