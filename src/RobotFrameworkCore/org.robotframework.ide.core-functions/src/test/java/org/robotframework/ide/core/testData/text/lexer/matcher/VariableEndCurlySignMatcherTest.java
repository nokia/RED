 ...
 */
public class VariableEndCurlySignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoCurrlyBracketCloseInTempBuffer_shouldReturn_two_SINGLE_VARIABLE_END_CURLY_BRACKET_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneCurrlyBracketCloseSignInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("}");
        ...
        assertTokens(
                output,
                new RobotSingleCharTokenType[] { RobotSingleCharTokenType.SINGLE_VARIABLE_END_CURLY_BRACKET },
                0, 1);
    }
    ...
    @Before
    public void setUp() {
        matcher = new VariableEndCurlySignMatcher();
    }
