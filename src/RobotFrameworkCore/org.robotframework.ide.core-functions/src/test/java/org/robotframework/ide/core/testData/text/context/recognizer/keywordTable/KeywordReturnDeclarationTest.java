 ...
 */
public class KeywordReturnDeclarationTest extends
        ARecognizerSequenceInBracketsTest {

    public KeywordReturnDeclarationTest() {
        super(KeywordReturnDeclaration.class);
    }
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.RETURN_WORD);
    }
