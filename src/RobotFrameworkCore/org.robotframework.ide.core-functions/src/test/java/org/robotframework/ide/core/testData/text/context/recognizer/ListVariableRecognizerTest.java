 ...
 */
public class ListVariableRecognizerTest extends ARecognizerTest {

    public ListVariableRecognizerTest() {
        super(ListVariableRecognizer.class);
    }


    @Test
    public void test_listInList() throws FileNotFoundException, IOException {
        // prepare
        String text = "foobar";
        ...
        assertThat(contextOne.getType()).isEqualTo(
                SimpleRobotContextType.LIST_VARIABLE);
    ...
    @Test
    public void test_listVariable_withoutAnyInsideTokens_withEscape()
    ...
    @Test
    public void test_listVariableAfterListVariable_withoutAnyInsideTokens()
            throws FileNotFoundException, IOException {
        // prepare
        String text = "foobar";
        TokenOutput tokenOutput = createTokenOutput("@@{" + text + "}");
    ...
    @Test
    public void test_listVariable_withoutAnyInsideTokens()
            throws FileNotFoundException, IOException {
        // prepare
        String text = "foobar";
        TokenOutput tokenOutput = createTokenOutput("@{" + text + "}");
    ...
    @Test
    public void test_onlyEscapedAtAndCurrlyBracketAndTextSign()
            throws FileNotFoundException, IOException {
    ...
    @Test
    public void test_onlyAtAndCurrlyBracketAndTextSign()
            throws FileNotFoundException, IOException {
        assertForIncorrectData("@{foobar");
    }
    ...
    @Test
    public void test_onlyAtAndCurrlyBracketSign() throws FileNotFoundException,
            IOException {
    ...
    @Test
    public void test_onlyAtSign() throws FileNotFoundException, IOException {
        assertForIncorrectData("@");
    }


    @Test
    public void test_noAtSign() throws FileNotFoundException, IOException {
        assertForIncorrectData("foobar");
    }
