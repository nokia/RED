...
public class TestMoveUpMethod {
    ...
    public void test_move_element_minus_1_inEmptyList_shouldReturn_False() {
        int index = -1;
        assertFalse("Move negative index " + index + " is not possible", testObject.moveUp(index));
    }
    ...
    public void test_move_element_0_inOneElementList_shouldReturn_False() {
        int index = 0;
        luckyNumbers.add(0);
        assertFalse("Move element " + index + " upper is not possible", testObject.moveUp(index));
    ...
    public void test_move_nonExisting_element_2_inOneElementList_shouldReturn_False() {
        int index = 2;
        luckyNumbers.add(0);
        assertFalse("Moving not existing element " + index + " is not possible", testObject.moveUp(index));
        assertThat(luckyNumbers).hasSize(1).contains(0, atIndex(0));
    }
    ...
    public void test_move_element_0_inTwoElementList_shouldReturn_False() {
        ...
        luckyNumbers.add(0);
        luckyNumbers.add(1);
        assertFalse("Moving element " + index + " is not possible", testObject.moveUp(index));
    ...
    public void test_move_element_1_inTwoElementList_shouldReturn_True() {
        ...
        luckyNumbers.add(0);
        luckyNumbers.add(1);
        assertTrue("Moving element " + index + " should be possible", testObject.moveUp(index));
