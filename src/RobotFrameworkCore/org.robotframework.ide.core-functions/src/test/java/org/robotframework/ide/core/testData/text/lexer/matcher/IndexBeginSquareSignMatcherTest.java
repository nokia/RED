 ...
 */
public class IndexBeginSquareSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoSquareBracketOpenInTempBuffer_shouldReturn_two_SINGLE_POSSITION_INDEX_BEGIN_SQUARE_BRACKET_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleSquareBracketOpenInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("[");
        ...
        assertTokens(
                output,
                new RobotSingleCharTokenType[] { RobotSingleCharTokenType.SINGLE_POSSITION_INDEX_BEGIN_SQUARE_BRACKET },
                0, 1);
    }
    ...
    @Before
    public void setUp() {
        matcher = new IndexBeginSquareSignMatcher();
    }
