 ...
 */
public class VariableBeginCurlySignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoCurrlyBracketOpenInTempBuffer_shouldReturn_two_SINGLE_VARIABLE_BEGIN_CURLY_BRACKET_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneCurrlyBracketOpenSignInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("{");
        ...
        assertTokens(
                output,
                new RobotSingleCharTokenType[] { RobotSingleCharTokenType.SINGLE_VARIABLE_BEGIN_CURLY_BRACKET },
                0, 1);
    }
    ...
    @Before
    public void setUp() {
        matcher = new VariableBeginCurlySignMatcher();
    }
