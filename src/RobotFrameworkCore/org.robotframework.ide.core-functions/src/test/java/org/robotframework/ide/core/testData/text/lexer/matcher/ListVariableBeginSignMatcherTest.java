 ...
 */
public class ListVariableBeginSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoAtSignsInTempBuffer_shouldReturn_two_SINGLE_LIST_BEGIN_AT_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleAtSignInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("@");
    ...
    @Before
    public void setUp() {
        matcher = new ListVariableBeginSignMatcher();
    }
