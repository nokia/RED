...
public class PipeMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoPipesInTempBuffer_shouldReturn_two_SINGLE_PIPE_tokens() {
        // prepare
        ...
        for (int charIndex = 0; charIndex < tempBuffer.length(); charIndex++) {
            ...
            if ((charIndex + 1) % 2 == 0) {
                expectedSequenceOfTypes = new IRobotTokenType[] {
                        ...
                        RobotSingleCharTokenType.SINGLE_ASTERISK,
                        RobotSingleCharTokenType.SINGLE_PIPE, RobotSingleCharTokenType.SINGLE_PIPE };
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSinglePipeInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("|");
        ...
        assertTokens(output,
                new RobotSingleCharTokenType[] { RobotSingleCharTokenType.SINGLE_PIPE }, 0, 1);
    }
