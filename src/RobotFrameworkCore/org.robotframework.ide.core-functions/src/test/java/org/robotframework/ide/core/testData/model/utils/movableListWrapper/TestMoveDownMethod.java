...
public class TestMoveDownMethod {
    ...
    public void test_move_element_0_to_1_inEmptyList_shouldReturn_False() {
        ...
        assertFalse("List is empty move element " + index + " to "
                + (index + 1) + " is not possible", testObject.moveDown(index));
    }
    ...
    public void test_move_element_minus_1_inEmptyList_shouldReturn_False() {
        int index = -1;
        assertFalse("Move element negative index " + index + " to "
                + (index + 1) + " is not possible", testObject.moveDown(index));
    ...
    public void test_move_element_0_to_1_inOneElementList_shouldReturn_False() {
        int index = 0;
        luckyNumbers.add(0);
        assertFalse("List has one element, so move " + index + " to "
                + (index + 1) + " is not possible", testObject.moveDown(index));
    ...
    public void test_move_element_0_to_1_inTwoElementList_shouldReturn_True() {
        ...
        luckyNumbers.add(0);
        luckyNumbers.add(1);
        assertTrue("Move from " + index + " to " + (index + 1)
                + " should be possible", testObject.moveDown(index));
    ...
    public void test_move_element_1_to_2_inTwoElementList_shouldReturn_False() {
        ...
        luckyNumbers.add(0);
        luckyNumbers.add(1);
        assertFalse("Move from " + index + " to " + (index + 1)
                + " should not be possible", testObject.moveDown(index));
