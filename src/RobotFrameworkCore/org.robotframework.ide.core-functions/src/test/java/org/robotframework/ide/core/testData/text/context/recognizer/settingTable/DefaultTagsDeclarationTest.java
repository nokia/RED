 ...
 */
public class DefaultTagsDeclarationTest extends
        ARecognizerSequenceWithOptionalLastColonTest {

    public DefaultTagsDeclarationTest() {
        super(DefaultTagsDeclaration.class);
    }


    @Test
    public void test_recognize_word_is_correct_witOptionalColon_shouldReturnOneContext()
            throws FileNotFoundException, IOException {
        // prepare
        String text = "Default Tags:";
        ...
        assertThat(comment.getType()).isEqualTo(
                SettingTableRobotContextType.TABLE_SETTINGS_DEFAULT_TAGS);

        assertTokensForUnknownWords(comment.getContextTokens(),
                new IRobotTokenType[] { RobotWordType.DEFAULT_WORD,
    ...
    public void test_recognize_word_is_correct_optionalColonIsNotPresent_shouldReturnOneContext()
        ...
        assertTokensForUnknownWords(comment.getContextTokens(),
                new IRobotTokenType[] { RobotWordType.DEFAULT_WORD,
                        RobotSingleCharTokenType.SINGLE_SPACE,
                        RobotWordType.TAGS_WORD }, 0, new FilePosition(1, 1),
                new String[] {});
    }
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.DEFAULT_WORD,
                RobotWordType.TAGS_WORD);
    }
