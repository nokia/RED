 ...
 */
public class EqualSignMatcherTest {
    ...
    @Test
    public void test_match_forTokenStoreWithTwoAsterisks_andWithTwoEqualsInTempBuffer_shouldReturn_two_SINGLE_EQUAL_tokens() {
        // prepare
    ...
    @Test
    public void test_match_forEmptyTokenStore_andWithOneSingleEqualInTempBuffer_shouldReturn_TRUE() {
        // prepare
        CharBuffer tempBuffer = CharBuffer.wrap("=");
        ...
        assertTokens(output,
                new RobotTokenType[] { RobotTokenType.SINGLE_EQUAL }, 0, 1);
    }
