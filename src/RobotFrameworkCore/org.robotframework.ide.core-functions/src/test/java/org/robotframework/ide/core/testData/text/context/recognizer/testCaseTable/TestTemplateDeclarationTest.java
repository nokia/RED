 ...
 */
public class TestTemplateDeclarationTest extends
        ARecognizerSequenceInBracketsTest {

    public TestTemplateDeclarationTest() {
        super(TestTemplateDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertThat(comment.getType())
                .isEqualTo(
                        TestCaseTableRobotContextType.TABLE_TEST_CASE_SETTINGS_TEMPLATE);
    ...
    public void test_getExpectedElements() {
        assertExpectedSequenceAllMandatory(RobotWordType.TEMPLATE_WORD);
    }
