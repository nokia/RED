 ...
 */
public class KeywordDocumentationDeclarationTest extends
        ARecognizerSequenceInBracketsTest {

    public KeywordDocumentationDeclarationTest() {
        super(KeywordDocumentationDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertTokensForUnknownWords(
                ...
                new IRobotTokenType[] {
                        ...
                        RobotWordType.DOCUMENTATION_WORD,
