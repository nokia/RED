 ...
 */
public class SuiteTeardownDeclarationTest extends
        ARecognizerSequenceWithOptionalLastColonTest {

    public SuiteTeardownDeclarationTest() {
        super(SuiteTeardownDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_withOptionalColon_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                SettingTableRobotContextType.TABLE_SETTINGS_SUITE_TEARDOWN);
