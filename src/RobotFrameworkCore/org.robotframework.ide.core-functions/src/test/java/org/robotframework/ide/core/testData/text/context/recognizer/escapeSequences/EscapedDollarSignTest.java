 ...
 */
public class EscapedDollarSignTest extends ARecognizerTest {

    public EscapedDollarSignTest() {
        super(EscapedDollarSign.class);
    }
    ...
    public void test_backslashFollowing_sign_shouldReturn_oneElement()
        ...
        assertForSingleTextWithSignDollar_atTheBeginning(additionalTextStartsWithSign);
    }


    private void assertForSingleTextWithSignDollar_atTheBeginning(
    ...
    @Test
    public void test_escapedBackslashAndThen_atDollar_shouldReturn_anEmptyList()
            throws FileNotFoundException, IOException {
        String text = "\\\\$";
    ...
    @Test
    public void test_noDollarSignFollowingBackslashCharacter_shouldReturn_anEmptyList()
            throws FileNotFoundException, IOException {
    ...
    public void test_getContextType() {
        assertThat(context.getContextType()).isEqualTo(
                SimpleRobotContextType.ESCAPED_DOLLAR_SIGN);
    }
}
