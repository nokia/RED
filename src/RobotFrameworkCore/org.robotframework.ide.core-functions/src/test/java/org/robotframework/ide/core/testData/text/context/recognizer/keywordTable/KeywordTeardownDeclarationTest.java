 ...
 */
public class KeywordTeardownDeclarationTest extends
        ARecognizerSequenceInBracketsTest {

    public KeywordTeardownDeclarationTest() {
        super(KeywordTeardownDeclaration.class);
    }
    ...
    public void test_recognize_word_is_correct_shouldReturnOneContext()
        ...
        assertThat(comment.getType()).isEqualTo(
                KeywordTableRobotContextType.TABLE_KEYWORD_SETTINGS_TEARDOWN);
